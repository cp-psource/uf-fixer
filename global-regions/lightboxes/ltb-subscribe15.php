...
$ltb_subscribe15->add_element("PlainTxt", array (
  ...
  array (
    ...
    'content' => '<h3 class="" style="text-align: center;">Abonnieren Sie unseren<br>Newsletter</h3>',
    'type' => 'PlainTxtModel',
...
<input type="email" id="user-email" name="user-email" placeholder="E-Mail-Addresse">

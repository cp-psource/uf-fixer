...
$services_inner_main = upfront_create_region(
  ...
  'title' => 'Dienstleistungen Inner Main',
  'type' => 'wide',
  'scope' => 'local',
...
$services_inner_main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'content' => '<h1 style="text-align: center;" rel="text-align: center;" class="">Dienstleistungen</h1>',
    'type' => 'PlainTxtModel',
...
<h3 class="" style="text-align: right;">Maurerarbeit <span class="uf_font_icon" style="font-size: 20px; top: 0px;" rel="font-size: 20px; top: 0px;" data-verified="redactor" data-redactor-tag="span" data-redactor-style="font-size: 20px; top: 0px;">d</span></h3>
</div>',
    'type' => 'PlainTxtModel',
...
$services_inner_main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 class=""><span class="uf_font_icon" style="font-size: 20px; top: 0px;" rel="font-size: 20px; top: 0px;" data-verified="redactor" data-redactor-tag="span" data-redactor-style="font-size: 20px; top: 0px;">g</span> Einzäunung</span></h3>',
    'type' => 'PlainTxtModel',
...
$services_inner_main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 class="" style="text-align: right;">Installation <span class="uf_font_icon" style="font-size: 20px; top: 0px;" rel="font-size: 20px; top: 0px;" data-verified="redactor" data-redactor-tag="span" data-redactor-style="font-size: 20px; top: 0px;">e</span></h3>',
    'type' => 'PlainTxtModel',
...
$services_inner_main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 class=""><span class="uf_font_icon" style="font-size: 20px; top: 0px;" rel="font-size: 20px; top: 0px;" data-verified="redactor" data-redactor-tag="span" data-redactor-style="font-size: 20px; top: 0px;">h</span> Fenster</h3>',
    'type' => 'PlainTxtModel',
...
$services_inner_main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 class="" style="text-align: right;">Elektrik <span class="uf_font_icon" style="font-size: 20px; top: 0px;" rel="font-size: 20px; top: 0px;" data-verified="redactor" data-redactor-tag="span" data-redactor-style="font-size: 20px; top: 0px;">f</span></h3>',
    'type' => 'PlainTxtModel',
...
$services_inner_main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 class=""><span class="uf_font_icon" style="font-size: 20px; top: 0px;" rel="font-size: 20px; top: 0px;" data-verified="redactor" data-redactor-tag="span" data-redactor-style="font-size: 20px; top: 0px;">i</span> Dachdecken</span></h3>',
    'type' => 'PlainTxtModel',
